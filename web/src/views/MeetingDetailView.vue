...
const tab=ref<'transcript'|'notes'|'export'>('transcript'),saving=ref(''),audioUrl=ref(''),audioAttempt=ref(0),audioError=ref(''),audioLoading=ref(false),audioReady=ref(false),audioPlaying=ref(false),audioCurrent=ref(0),audioDuration=ref(0)
