...
function Ensure-EnvConfig([string]$Device = "cpu", [string]$AsrEngine = "sensevoice_zh", [string]$FaceDevice = "") {
    ...
    Set-EnvFileValue ".env" "AUDIO_ENHANCEMENT_ENABLED" "true"
    Set-EnvFileValue ".env" "AUDIO_ENHANCEMENT_PROFILE" "meeting"
    Set-EnvFileValue ".env" "AUDIO_ENHANCEMENT_HIGH_PASS_HZ" "80"
    Set-EnvFileValue ".env" "AUDIO_ENHANCEMENT_LOW_PASS_HZ" "7600"
    Set-EnvFileValue ".env" "AUDIO_ENHANCEMENT_NOISE_REDUCTION" "0.35"
    Set-EnvFileValue ".env" "AUDIO_ENHANCEMENT_NOISE_FLOOR" "0.08"
    Set-EnvFileValue ".env" "AUDIO_ENHANCEMENT_TARGET_RMS" "0.08"
    Set-EnvFileValue ".env" "AUDIO_ENHANCEMENT_MAX_GAIN" "8.0"
    Set-EnvFileValue ".env" "AUDIO_ENHANCEMENT_MAX_BLOCK_SECONDS" "30"
    Set-EnvFileValue ".env" "AUDIO_ENHANCEMENT_COMPRESSION_THRESHOLD" "0.12"
    Set-EnvFileValue ".env" "AUDIO_ENHANCEMENT_COMPRESSION_RATIO" "2.5"
    Set-EnvFileValue ".env" "AUDIO_OVERLAP_DETECTION_ENABLED" "true"
    Set-EnvFileValue ".env" "AUDIO_OVERLAP_THRESHOLD" "0.68"
    Set-EnvFileValue ".env" "AUDIO_OVERLAP_MIN_DURATION" "0.45"
...
function Ensure-FrontendBuild {
    ...
    if (-not $ForceFrontendBuild -and (Test-FrontendBuildCurrent)) {
