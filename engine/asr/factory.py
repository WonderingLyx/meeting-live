...
ASR_ENGINE_CONFIG: dict[str, dict[str, Any]] = {
    ...
    "sensevoice_spk": {
        "name": "SenseVoice-Small + Speaker Tags",
        "model": "iic/SenseVoiceSmall + fsmn-vad + cam++",
        "description": "SenseVoice 中文快速转写,同时输出 FunASR 匿名说话人标签,适合和独立说话人分离做对照",
        "description_en": "Fast SenseVoice Chinese transcription with FunASR anonymous speaker tags for comparison",
        "languages": "中文/粤语/英语/日语/韩语",
        "languages_en": "Chinese / Cantonese / English / Japanese / Korean",
        "supports_streaming": False,
        "supports_words": False,
        "optional_dependency": "funasr",
        "capabilities": {
            ...
            "timestamp_granularity": "dynamic",
            "native_metadata": True,
            "recommended_for": ["chinese_fast_upload", "speaker_tag_baseline"],
            "amd_windows": "prefer_cpu_first",
            "notes": "CAM++ 只给本段音频内匿名 speaker index,不是已登记人员身份;中文会议建议先和 sensevoice_zh 对比。",
            "notes_en": "CAM++ returns anonymous speaker indices inside the current audio, not enrolled identities.",
        },
    },
    "paraformer": {
        "name": "Paraformer",
    ...
    "seaco_paraformer": {
        "name": "SeACo Paraformer Hotword",
        "model": "iic/speech_seaco_paraformer_large_asr_nat-zh-cn-16k-common-vocab8404-pytorch",
        "description": "中文热词增强 Paraformer,适合人名、部门名、项目名较多的会议",
        "description_en": "Chinese hotword-aware Paraformer for meetings with many names, teams, and domain terms",
        "languages": "中文/英语",
        "languages_en": "Chinese / English",
        "supports_streaming": False,
        "supports_words": False,
        ...
        "capabilities": {
            ...
            "timestamp_granularity": "dynamic",
            "native_metadata": True,
            "recommended_for": ["chinese_meeting_upload", "hotwords", "proper_nouns"],
            "amd_windows": "prefer_cpu_first",
            "notes": "使用 ASR_FUNASR_HOTWORDS 配置热词;首次切换会从 ModelScope 下载 SeACo Paraformer。",
            "notes_en": "Configure hotwords with ASR_FUNASR_HOTWORDS; first switch downloads SeACo Paraformer from ModelScope.",
        },
    },
    "paraformer_large": {
    ...
    "paraformer_online": {
        ...
        "description": "ModelScope Paraformer 中文在线/低延迟模型,适合实时会议延迟对照",
        "description_en": "ModelScope Paraformer Chinese online/low-latency model for live latency comparison",
        "languages": "中文/英语",
        "languages_en": "Chinese / English",
        ...
        "capabilities": {
            ...
            "timestamp_granularity": "dynamic",
            "native_metadata": True,
            "recommended_for": ["low_latency_chinese", "amd_windows_latency_test"],
            "amd_windows": "prefer_cpu_first",
            "notes": "模型本身是在线流式模型;当前项目仍按 VAD 语音段调用,可作为低延迟对照。",
            "notes_en": "The checkpoint is streaming-capable; this app still calls it on VAD segments for now.",
        },
    },
...
def _normalize_engine_type(engine_type: str | None) -> str:
    ...
    aliases = {
        ...
        "sensevoice_speaker": "sensevoice_spk",
        "sensevoice_spk": "sensevoice_spk",
        "sensevoice_speaker_tags": "sensevoice_spk",
        ...
        "seaco": "seaco_paraformer",
        "seaco_paraformer": "seaco_paraformer",
        "seaco_paraformer_hotword": "seaco_paraformer",
        "paraformer_hotword": "seaco_paraformer",
        "hotword_paraformer": "seaco_paraformer",
        ...
        "paraformer_online": "paraformer_online",
        "paraformer_zh_online": "paraformer_online",
        "funasr_online": "paraformer_online",
